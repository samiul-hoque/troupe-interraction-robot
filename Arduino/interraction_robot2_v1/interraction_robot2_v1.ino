...
void debugNetwork(){
  ...
  Serial.print("id: ");
  Serial.print(robot2data.id);
  Serial.print(",");
  Serial.print("icounter: ");
  Serial.print(robot2data.icounter);
  Serial.print("  ");
...
void publishData(){
   esp_err_t result1 = esp_now_send(robot1, (uint8_t *)&robot2data, sizeof(robot2data));
   if (result1 == ESP_OK) {
...
//    Serial.println("Error sending the data");
//  }
  esp_err_t result3 = esp_now_send(robot3, (uint8_t *)&robot2data, sizeof(robot2data));
  if (result3 == ESP_OK) {
    //Serial.println("Sent with success");
  } else {
