...
void debugNetwork(){
  ...
  Serial.print("id: ");
  Serial.print(boardsStruct[0].id);
  Serial.print(",");
  Serial.print("icounter: ");
  Serial.print(boardsStruct[0].icounter);
  Serial.print("  ");
  ...
  Serial.print("id: ");
  Serial.print(robot3data.id);
  Serial.print(",");
  Serial.print("icounter: ");
  Serial.println(robot3data.icounter);
  }

void publishData(){
   esp_err_t result1 = esp_now_send(robot1, (uint8_t *)&robot3data, sizeof(robot3data));
   if (result1 == ESP_OK) {
     //Serial.println("Sent with success");
   } else {
     //Serial.println("Error sending the data");
   }
  esp_err_t result2 = esp_now_send(robot2, (uint8_t *)&robot3data, sizeof(robot3data));
  if (result2 == ESP_OK) {
    //Serial.println("Sent with success");
  } else {
    //Serial.println("Error sending the data");
...
//happy state
  if (interractionCounter > interractionThreshhold){
    emotionalState = 2;
    robot3data.icounter = 2;
  }else{
    robot3data.icounter = -1;
    }
